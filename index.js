...
client.on('ready', () => {
  client.user.setGame(`on ? servers | *help | By @HiMoxY#9364 .`,'https://www.twitch.tv/himoxysni');
  console.log('---------------');
...
'*** انا لست الحوت الازرق كما يدعون ***',
   ...
   '*** مريم : اضغط على الرابط اهداء مني لك | https://www.youtube.com/channel/UCjSUJj-yAhHjw5PAk4IvYYQ ***',
 ...
 **
رابط البوت | https://discordapp.com/oauth2/authorize/?permissions=2146958591&scope=bot&client_id=416361886423187458
 **
`);
  message.author.sendEmbed(embed);
   }
 ...
 **
رابط السيرفر | https://discord.gg/WfT9Vu9
 **
`);
  message.author.sendEmbed(embed);
   }
...
client.on('ready', function(){
    ...
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`https://www.twitch.tv/himoxysni`);
    }, ms);100000
